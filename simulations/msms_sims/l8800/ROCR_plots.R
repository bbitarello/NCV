...
pdf("ROC_05_af_zoom.pdf")



plot(perf5, main='AFRICA, NCV feq=0.5 vs Taj D; 3 my ', col='turquoise4', xlim=c(0,0.3))
...
legend(0.25,0.22,c('sims feq=0.5 (NCV)','sims feq=0.5 (TajD)','sims feq=0.4 (NCV)', 'sims feq=0.4 (TajD)','sims feq=0.3 (NCV)', 'sims feq=0.3 (tajD)', 'sims feq=0.2 (NCV)', 'sims feq=0.2 (TajD)', 'sims feq=0.1 (NCV)','sims feq=0.1 (TajD)'),col=c('turquoise4','turquoise4','orange','orange',  'darkolivegreen','darkolivegreen', 'brown', 'brown','red','red'),lty=c(1,2,1,2,1,2,1,2,1,2), cex=0.55)
abline(coef=c(0,1), col='lightgray', lty=2)
abline(v=0.01, col='gray', lty=2)
abline(v=0.05, col='darkgray', lty=2)
dev.off()
...
pdf("ROC_05_eu_zoom.pdf")



plot(perf5eu, main='EUROPE, NCV feq=0.5 vs Taj D; 3 my ', col='turquoise4', xlim=c(0,0.3))
...
legend(0.2,0.22,c('sims feq=0.5 (NCV)','sims feq=0.5 (TajD)','sims feq=0.4 (NCV)', 'sims feq=0.4 (TajD)','sims feq=0.3 (NCV)', 'sims feq=0.3 (tajD)', 'sims feq=0.2 (NCV)', 'sims feq=0.2 (TajD)', 'sims feq=0.1 (NCV)','sims feq=0.1 (TajD)'),col=c('turquoise4','turquoise4','orange','orange',  'darkolivegreen','darkolivegreen', 'brown', 'brown','red','red'),lty=c(1,2,1,2,1,2,1,2,1,2), cex=0.55)
abline(coef=c(0,1), col='lightgray', lty=2)
abline(v=0.01, col='gray', lty=2)
abline(v=0.05, col='darkgray', lty=2)
dev.off()
