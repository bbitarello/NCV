...
SIMS$MN <- read.ms("/mnt/sequencedb/PopGen/barbara/simulations/msms_sims/l8800/mN.out", Npop=4,Nchr=c(rep(nchr,3),1))

SIMS$M3f01<-read.ms("/mnt/sequencedb/PopGen/barbara/simulations/msms_sims/l8800/ms3f01.out", Npop=4, Nchr=c(rep(nchr,3),1))

SIMS$M3f02<-read.ms("/mnt/sequencedb/PopGen/barbara/simulations/msms_sims/l8800/ms3f02.out", Npop=4, Nchr=c(rep(nchr,3),1))

SIMS$M3f03<-read.ms("/mnt/sequencedb/PopGen/barbara/simulations/msms_sims/l8800/ms3f03.out", Npop=4, Nchr=c(rep(nchr,3),1))

SIMS$M3f04<-read.ms("/mnt/sequencedb/PopGen/barbara/simulations/msms_sims/l8800/ms3f04.out", Npop=4, Nchr=c(rep(nchr,3),1))

SIMS$M3f05<-read.ms("/mnt/sequencedb/PopGen/barbara/simulations/msms_sims/l8800/ms3f05.out", Npop=4, Nchr=c(rep(nchr,3),1))

#

SIMS$M1f01<-read.ms("/mnt/sequencedb/PopGen/barbara/simulations/msms_sims/l8800/ms1f01.out", Npop=4, Nchr=c(rep(nchr,3),1))

SIMS$M1f02<-read.ms("/mnt/sequencedb/PopGen/barbara/simulations/msms_sims/l8800/ms1f02.out", Npop=4, Nchr=c(rep(nchr,3),1))

SIMS$M1f03<-read.ms("/mnt/sequencedb/PopGen/barbara/simulations/msms_sims/l8800/ms1f03.out", Npop=4, Nchr=c(rep(nchr,3),1))

SIMS$M1f04<-read.ms("/mnt/sequencedb/PopGen/barbara/simulations/msms_sims/l8800/ms1f04.out", Npop=4, Nchr=c(rep(nchr,3),1))

SIMS$M1f05<-read.ms("/mnt/sequencedb/PopGen/barbara/simulations/msms_sims/l8800/ms1f05.out", Npop=4, Nchr=c(rep(nchr,3),1))
#######################################################################
