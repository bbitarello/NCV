...
tbs3_f0.4_l3kb_n20 <- paste(msms, "-N 7310 -ms 61", nsims," -t",THETA, "-r", RHO, Length, "-I 4 20 20 20 1 0 -n 1 1.98003 -n 2 4.62571 -n 3 6.20653 -n 4 2.7398 -eg 0 2 110.7738 -eg 0 3 139.8551 -ma x 0.731 0.22807 0 0.731 x 0.90936 0 0.22807 0.90936 x 0 0 0 0 x -ej 0.0315 3 2 -en 0.0315 2 0.2546 -ema 0.0315 4 x 4.386 x 0 4.386 x x 0 x x x x 0 0 x x -ej 0.0698 2 1 -en 0.2025 1 1 -em 0.0698 1 4 0 -em 0.0698 4 1 0 -ej 8.892488 1 4 -SFC -SI", T1, "4", f.i, "0 0 0 -Sc 0 0", SEL2, "-Sp 0.5 -Smark >", ms.out)
...
tbs1_f0.5_l3kb_n20 <- paste(msms, "-N 7310 -ms 61", nsims," -t",THETA, "-r", RHO, Length, "-I 4 20 20 20 1 0 -n 1 1.98003 -n 2 4.62571 -n 3 6.20653 -n 4 2.7398 -eg 0 2 110.7738 -eg 0 3 139.8551 -ma x 0.731 0.22807 0 0.731 x 0.90936 0 0.22807 0.90936 x 0 0 0 0 x -ej 0.0315 3 2 -en 0.0315 2 0.2546 -ema 0.0315 4 x 4.386 x 0 4.386 x x 0 x x x x 0 0 x x -ej 0.0698 2 1 -en 0.2025 1 1 -em 0.0698 1 4 0 -em 0.0698 4 1 0 -ej 8.892488 1 4 -SFC -SI", T2, "4", f.i, "0 0 0 -Sc 0 0", SEL2, "-Sp 0.5 -Smark >", ms.out)

## simulations parameters
SEL2 <- paste(round(fr2w(0.10,Sbs,Ne)), collapse=" ") #equilibrium frequency 0.1
ms.out <- "tbs1_f0.1_l3kb_n20.out"
tbs1_f0.1_l3kb_n20 <- paste(msms, "-N 7310 -ms 61", nsims," -t",THETA, "-r", RHO, Length, "-I 4 20 20 20 1 0 -n 1 1.98003 -n 2 4.62571 -n 3 6.20653 -n 4 2.7398 -eg 0 2 110.7738 -eg 0 3 139.8551 -ma x 0.731 0.22807 0 0.731 x 0.90936 0 0.22807 0.90936 x 0 0 0 0 x -ej 0.0315 3 2 -en 0.0315 2 0.2546 -ema 0.0315 4 x 4.386 x 0 4.386 x x 0 x x x x 0 0 x x -ej 0.0698 2 1 -en 0.2025 1 1 -em 0.0698 1 4 0 -em 0.0698 4 1 0 -ej 8.892488 1 4 -SFC -SI", T2, "4", f.i, "0 0 0 -Sc 0 0", SEL2, "-Sp 0.5 -Smark >", ms.out)
## simulations parameters
SEL2 <- paste(round(fr2w(0.20,Sbs,Ne)), collapse=" ") #equilibrium frequency 0.2
ms.out <- "tbs1_f0.2_l3kb_n20.out"
tbs1_f0.2_l3kb_n20 <- paste(msms, "-N 7310 -ms 61", nsims," -t",THETA, "-r", RHO, Length, "-I 4 20 20 20 1 0 -n 1 1.98003 -n 2 4.62571 -n 3 6.20653 -n 4 2.7398 -eg 0 2 110.7738 -eg 0 3 139.8551 -ma x 0.731 0.22807 0 0.731 x 0.90936 0 0.22807 0.90936 x 0 0 0 0 x -ej 0.0315 3 2 -en 0.0315 2 0.2546 -ema 0.0315 4 x 4.386 x 0 4.386 x x 0 x x x x 0 0 x x -ej 0.0698 2 1 -en 0.2025 1 1 -em 0.0698 1 4 0 -em 0.0698 4 1 0 -ej 8.892488 1 4 -SFC -SI", T2, "4", f.i, "0 0 0 -Sc 0 0", SEL2, "-Sp 0.5 -Smark >", ms.out)
...
tbs1_f0.4_l3kb_n20 <- paste(msms, "-N 7310 -ms 61", nsims," -t",THETA, "-r", RHO, Length, "-I 4 20 20 20 1 0 -n 1 1.98003 -n 2 4.62571 -n 3 6.20653 -n 4 2.7398 -eg 0 2 110.7738 -eg 0 3 139.8551 -ma x 0.731 0.22807 0 0.731 x 0.90936 0 0.22807 0.90936 x 0 0 0 0 x -ej 0.0315 3 2 -en 0.0315 2 0.2546 -ema 0.0315 4 x 4.386 x 0 4.386 x x 0 x x x x 0 0 x x -ej 0.0698 2 1 -en 0.2025 1 1 -em 0.0698 1 4 0 -em 0.0698 4 1 0 -ej 8.892488 1 4 -SFC -SI", T2, "4", f.i, "0 0 0 -Sc 0 0", SEL2, "-Sp 0.5 -Smark >", ms.out)
...
nchr60=60
nchr20=20
SIMS_l3kb$Neutral_3kb_n100 <- read.ms("neutral_n100_l3kb.out", Npop=4,Nchr=c(rep(nchr100,3),1))
...
SIMS_l3kb$Neutral_3kb_n60 <- read.ms("neutral_n60_l3kb.out", Npop=4,Nchr=c(rep(nchr60,3),1))
...
SIMS_l3kb$Neutral_3kb_n20 <- read.ms("neutral_n20_l3kb.out", Npop=4,Nchr=c(rep(nchr20,3),1))
