...
## 15-01-2014
## Last modified by Barbara Bitarello: 12.05.2014
## Run NCV:
...
assign(paste('res__',TAG, '_', BIN,'scanv7_noFDs',sep=''), do.call(rbind,chNCV))
}
if(FD==FALSE){
  ...
  assign(paste('res__',TAG, '_', BIN,'scanv7_noFDs',sep=''), do.call(rbind,chNCV))  ##save NCV results
}
...
objectName<-paste('res__',TAG, '_', BIN, 'scanv7_noFDs',sep='')
