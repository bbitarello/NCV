...
assign(paste('res__',TAG, '_', BIN,'scanv7',sep=''), do.call(rbind,chNCV))
}
if(FD==FALSE){
  ...
  assign(paste('res__',TAG, '_', BIN,'scanv7',sep=''), do.call(rbind,chNCV))  ##save NCV results
}
...
objectName<-paste('res__',TAG, '_', BIN, 'scanv7',sep='')
